...
######### Axis limits #############################
###################################################
def axis_lim(grid, win, plot, figure):
    '''
    ...
    xmin.textChanged.connect(partial(axis_lim_event, win, plot, figure, xmin, xmax, ymin, ymax, LogX, LogY))
    xmax.textChanged.connect(partial(axis_lim_event, win, plot, figure, xmin, xmax, ymin, ymax, LogX, LogY))
    ymin.textChanged.connect(partial(axis_lim_event, win, plot, figure, xmin, xmax, ymin, ymax, LogX, LogY))
    ymax.textChanged.connect(partial(axis_lim_event, win, plot, figure, xmin, xmax, ymin, ymax, LogX, LogY))
    LogY.stateChanged.connect(partial(axis_lim_event, win, plot, figure, xmin, xmax, ymin, ymax, LogX, LogY)) 
    LogX.stateChanged.connect(partial(axis_lim_event, win, plot, figure, xmin, xmax, ymin, ymax, LogX, LogY))

def axis_lim_event(win, plot, figure, wid1, wid2, wid3, wid4, logx, logy):
    '''
...
def background(grid, win, plot, figure, conf):
    ...
    ###and lick an event when the color is selected in the combo box
...
def background_event(win, plot, figure, wid, conf):
    ...
    #[print(method_name) for method_name in dir(figure) if callable(getattr(figure, method_name))]
